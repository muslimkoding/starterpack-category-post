...
<main class="form-signin">
  <form method="POST" action="/register">
    ...
    {{-- <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" placeholder="John Doe" value="{{ old('name') }}" name="name">
    ...
    <div class="form-floating mb-0">
      <input type="password" class="form-control" id="floatingInput" placeholder="Konfirmasi Password" name="password_confirmation">
      <label for="floatingInput">Password</label>
    </div>
